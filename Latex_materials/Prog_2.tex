...
\begin{document}
	...
	which is the basis for many of the classical mechanical equations of motion (e.g. Newton's Second Law). Just as the Lagrangian of a classical system would be used to obtain its equations of motion, the same is true of the SM, and the SM can be described by the Langrangian formalism:
	...
	In order to understand the SM, it is important to first understand the concept of a gauge theory. Consider a complex scalar field with mass $m$ described by the Lagrangian density (henceforth simply called "Lagrangian"):
