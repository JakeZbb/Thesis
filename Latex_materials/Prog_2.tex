...
\begin{document}
	...
	however gauge invariance is lost under a global U(1) transformation. The symmetry can be restored with the introduction of the covariant derivative $D_{\mu}$ and the photon vector field $A_{\mu}$ describing the interactions between fermions and photons. \par
	...
	The introduction of this tensor results in a QED Lagrangian of the form
